    ...
    <footer className="footer">
      <div className="footer-inner">
        <div className="footer-brand">
          <div className="footer-logo">
            ...
            <span className="footer-logo-text">SupportZone</span>
          </div>
          <p className="footer-tagline">Empowering support teams to resolve every issue with confidence and clarity.</p>
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-inner">
          <p>© 2026 SupportZone. All rights reserved.</p>
